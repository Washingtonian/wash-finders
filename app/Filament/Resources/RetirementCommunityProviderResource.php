...
use App\Filament\Resources\RetirementCommunityProviderResource\Pages\CreateRetirementCommunityProvider;
use App\Filament\Resources\RetirementCommunityProviderResource\Pages\EditRetirementCommunityProvider;
use App\Filament\Resources\RetirementCommunityProviderResource\Pages\ListRetirementCommunityProviders;
...
class RetirementCommunityProviderResource extends Resource
{
    protected static ?string $model = Provider::class;

    protected static BackedEnum|string|null $navigationIcon = 'heroicon-o-building-office';

    protected static ?string $navigationLabel = 'Retirement Communities';

    protected static ?string $modelLabel = 'Retirement Community';

    protected static ?string $pluralModelLabel = 'Retirement Communities';
        ...
        return $schema
            ->schema([
                ...
                FileUpload::make('photo')
                    ->label('Photo')
                    ->image()
                    ->directory('enhanced_photos/retirement_communities')
                    ->visibility('public'),
                KeyValue::make('meta')
                    ->keyLabel('Key')
                    ->valueLabel('Value')
    ...
    {
        return $table
            ->modifyQueryUsing(fn (Builder $query) => $query->where('type', 'retirement_communities'))
            ->columns([
    ...
    {
        return [
            'index' => ListRetirementCommunityProviders::route('/'),
            'create' => CreateRetirementCommunityProvider::route('/create'),
            'edit' => EditRetirementCommunityProvider::route('/{record}/edit'),
        ];
    }
    ...
    {
        $parameters['type'] = 'retirement_communities';
    ...
    {
        return static::getModel()::where('type', 'retirement_communities')->count();
    }
