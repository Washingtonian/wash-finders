...
use App\Filament\Resources\RetirementCommunityProviderResource\Pages;
...
class RetirementCommunityProviderResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListRetirementCommunityProviders::route('/'),
            'create' => Pages\CreateRetirementCommunityProvider::route('/create'),
            'edit' => Pages\EditRetirementCommunityProvider::route('/{record}/edit'),
        ];
    }
