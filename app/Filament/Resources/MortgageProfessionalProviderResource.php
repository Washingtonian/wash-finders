...
use App\Filament\Resources\MortgageProfessionalProviderResource\Pages\CreateMortgageProfessionalProvider;
use App\Filament\Resources\MortgageProfessionalProviderResource\Pages\EditMortgageProfessionalProvider;
use App\Filament\Resources\MortgageProfessionalProviderResource\Pages\ListMortgageProfessionalProviders;
...
class MortgageProfessionalProviderResource extends Resource
{
    ...
    {
        return [
            'index' => ListMortgageProfessionalProviders::route('/'),
            'create' => CreateMortgageProfessionalProvider::route('/create'),
            'edit' => EditMortgageProfessionalProvider::route('/{record}/edit'),
        ];
    }
