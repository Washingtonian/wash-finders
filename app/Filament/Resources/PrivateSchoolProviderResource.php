...
use App\Filament\Resources\PrivateSchoolProviderResource\Pages;
...
class PrivateSchoolProviderResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListPrivateSchoolProviders::route('/'),
            'create' => Pages\CreatePrivateSchoolProvider::route('/create'),
            'edit' => Pages\EditPrivateSchoolProvider::route('/{record}/edit'),
        ];
    }
