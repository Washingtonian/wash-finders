...
use App\Filament\Resources\PrivateSchoolProviderResource\Pages\CreatePrivateSchoolProvider;
use App\Filament\Resources\PrivateSchoolProviderResource\Pages\EditPrivateSchoolProvider;
use App\Filament\Resources\PrivateSchoolProviderResource\Pages\ListPrivateSchoolProviders;
...
class PrivateSchoolProviderResource extends Resource
{
    protected static ?string $model = Provider::class;

    protected static BackedEnum|string|null $navigationIcon = 'heroicon-o-academic-cap';

    protected static ?string $navigationLabel = 'Private Schools';

    protected static ?string $modelLabel = 'Private School';

    protected static ?string $pluralModelLabel = 'Private Schools';
        ...
        return $schema
            ->schema([
                ...
                FileUpload::make('photo')
                    ->label('Photo')
                    ->image()
                    ->directory('enhanced_photos/private_schools')
                    ->visibility('public'),
                KeyValue::make('meta')
                    ->keyLabel('Key')
                    ->valueLabel('Value')
    ...
    {
        return $table
            ->modifyQueryUsing(fn (Builder $query) => $query->where('type', 'private_schools'))
            ->columns([
    ...
    {
        return [
            'index' => ListPrivateSchoolProviders::route('/'),
            'create' => CreatePrivateSchoolProvider::route('/create'),
            'edit' => EditPrivateSchoolProvider::route('/{record}/edit'),
        ];
    }
    ...
    {
        $parameters['type'] = 'private_schools';
