...
use App\Filament\Resources\FinancialAdvisorProviderResource\Pages\CreateFinancialAdvisorProvider;
use App\Filament\Resources\FinancialAdvisorProviderResource\Pages\EditFinancialAdvisorProvider;
use App\Filament\Resources\FinancialAdvisorProviderResource\Pages\ListFinancialAdvisorProviders;
...
class FinancialAdvisorProviderResource extends Resource
{
    protected static ?string $model = Provider::class;

    protected static BackedEnum|string|null $navigationIcon = 'heroicon-o-currency-dollar';

    protected static ?string $navigationLabel = 'Financial Advisors';

    protected static ?string $modelLabel = 'Financial Advisor';

    protected static ?string $pluralModelLabel = 'Financial Advisors';
        ...
        return $schema
            ->schema([
                ...
                FileUpload::make('photo')
                    ->label('Photo')
                    ->image()
                    ->directory('enhanced_photos/financial_advisors')
                    ->visibility('public'),
                KeyValue::make('meta')
                    ->keyLabel('Key')
                    ->valueLabel('Value')
    ...
    {
        return $table
            ->modifyQueryUsing(fn (Builder $query) => $query->where('type', 'financial_advisors'))
            ->columns([
    ...
    {
        return [
            'index' => ListFinancialAdvisorProviders::route('/'),
            'create' => CreateFinancialAdvisorProvider::route('/create'),
            'edit' => EditFinancialAdvisorProvider::route('/{record}/edit'),
        ];
    }
    ...
    {
        $parameters['type'] = 'financial_advisors';
    ...
    {
        return static::getModel()::where('type', 'financial_advisors')->count();
    }
