...
use App\Filament\Resources\FinancialAdvisorProviderResource\Pages;
...
class FinancialAdvisorProviderResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListFinancialAdvisorProviders::route('/'),
            'create' => Pages\CreateFinancialAdvisorProvider::route('/create'),
            'edit' => Pages\EditFinancialAdvisorProvider::route('/{record}/edit'),
        ];
    }
