...
use App\Filament\Resources\RealtorProviderResource\Pages\CreateRealtorProvider;
use App\Filament\Resources\RealtorProviderResource\Pages\EditRealtorProvider;
use App\Filament\Resources\RealtorProviderResource\Pages\ListRealtorProviders;
...
class RealtorProviderResource extends Resource
{
    ...
    {
        return [
            'index' => ListRealtorProviders::route('/'),
            'create' => CreateRealtorProvider::route('/create'),
            'edit' => EditRealtorProvider::route('/{record}/edit'),
        ];
    }
