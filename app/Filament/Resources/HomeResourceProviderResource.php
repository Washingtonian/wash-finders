...
use App\Filament\Resources\HomeResourceProviderResource\Pages;
...
class HomeResourceProviderResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListHomeResourceProviders::route('/'),
            'create' => Pages\CreateHomeResourceProvider::route('/create'),
            'edit' => Pages\EditHomeResourceProvider::route('/{record}/edit'),
        ];
    }
