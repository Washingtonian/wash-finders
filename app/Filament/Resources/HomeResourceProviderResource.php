...
use App\Filament\Resources\HomeResourceProviderResource\Pages\CreateHomeResourceProvider;
use App\Filament\Resources\HomeResourceProviderResource\Pages\EditHomeResourceProvider;
use App\Filament\Resources\HomeResourceProviderResource\Pages\ListHomeResourceProviders;
...
class HomeResourceProviderResource extends Resource
{
    protected static ?string $model = Provider::class;

    protected static BackedEnum|string|null $navigationIcon = 'heroicon-o-wrench-screwdriver';

    protected static ?string $navigationLabel = 'Home Resources';

    protected static ?string $modelLabel = 'Home Resource';

    protected static ?string $pluralModelLabel = 'Home Resources';
        ...
        return $schema
            ->schema([
                ...
                FileUpload::make('photo')
                    ->label('Photo')
                    ->image()
                    ->directory('enhanced_photos/home_resources')
                    ->visibility('public'),
                KeyValue::make('meta')
                    ->keyLabel('Key')
                    ->valueLabel('Value')
    ...
    {
        return $table
            ->modifyQueryUsing(fn (Builder $query) => $query->where('type', 'home_resources'))
            ->columns([
    ...
    {
        return [
            'index' => ListHomeResourceProviders::route('/'),
            'create' => CreateHomeResourceProvider::route('/create'),
            'edit' => EditHomeResourceProvider::route('/{record}/edit'),
        ];
    }
    ...
    {
        $parameters['type'] = 'home_resources';
