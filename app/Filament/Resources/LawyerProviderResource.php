...
use App\Filament\Resources\LawyerProviderResource\Pages\CreateLawyerProvider;
use App\Filament\Resources\LawyerProviderResource\Pages\EditLawyerProvider;
use App\Filament\Resources\LawyerProviderResource\Pages\ListLawyerProviders;
...
class LawyerProviderResource extends Resource
{
    ...
    {
        return [
            'index' => ListLawyerProviders::route('/'),
            'create' => CreateLawyerProvider::route('/create'),
            'edit' => EditLawyerProvider::route('/{record}/edit'),
        ];
    }
