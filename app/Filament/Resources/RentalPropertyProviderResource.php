...
use App\Filament\Resources\RentalPropertyProviderResource\Pages;
...
class RentalPropertyProviderResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListRentalPropertyProviders::route('/'),
            'create' => Pages\CreateRentalPropertyProvider::route('/create'),
            'edit' => Pages\EditRentalPropertyProvider::route('/{record}/edit'),
        ];
    }
