...
use App\Filament\Resources\PetVendorProviderResource\Pages\CreatePetVendorProvider;
use App\Filament\Resources\PetVendorProviderResource\Pages\EditPetVendorProvider;
use App\Filament\Resources\PetVendorProviderResource\Pages\ListPetVendorProviders;
...
class PetVendorProviderResource extends Resource
{
    ...
    {
        return [
            'index' => ListPetVendorProviders::route('/'),
            'create' => CreatePetVendorProvider::route('/create'),
            'edit' => EditPetVendorProvider::route('/{record}/edit'),
        ];
    }
